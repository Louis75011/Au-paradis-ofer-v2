// js\data.js apps\web\public\js\data.js
// apps\web\public\js\data.js
(() => {
    // vos const evenements, chevaux, installations, tarifs, gites, avis, faqData
    // ... (gardez votre contenu tel quel)
    const evenements = [
        {
    ...
    // IMPORTANT : n’exposez pas les const en global, exposez uniquement APO_DATA
    window.APO_DATA = {
        evenements,
        chevaux,
        installations,
